...
public class SignUp extends AppCompatActivity {
    ...
    String url = "https://doctorshelpcare.000webhostapp.com/register.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed_ConfirmPassword = findViewById(R.id.ed_confirm_password);
        str_name = str_email = str_password = str_confirmPassword = "";
    ...
    public void Register(View view) {
        ...
        if(ed_username.getText().toString().equals("")){
            ...
            str_confirmPassword = ed_ConfirmPassword.getText().toString().trim();
